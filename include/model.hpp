...
class Model 
{
    ...
    private:
        ...
        Mesh processMesh(aiMesh *mesh, const aiScene *scene)
        {
            ...
            // 3. normal maps -> aiTextureType_HEIGHT is originally used in tutorial, seems like history problem
            std::vector<TextureStruct> normalMaps = loadMaterialTextures(material, aiTextureType_NORMALS, "texture_normal");
            textures.insert(textures.end(), normalMaps.begin(), normalMaps.end());
            // 4. height maps -> aiTextureType_AMBIENT is originally used in tutorial, seems like history problem
